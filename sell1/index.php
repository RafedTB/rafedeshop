...
if(isset($_POST['order'])){
   ...
   if($user_id == ''){
      ...
      $total_products1 = $_POST['total_products1'];
      ...
      if($select_cart->rowCount() > 0){
         ...
         $insert_order->execute([$user_id, $name, $number, $method, $address, $total_products1, $total_price]);
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>E</span>Change</a>

      <nav class="navbar">
         <a href="#home">home</a>
         <a href="#about">about</a>
         <a href="#menu">Echange</a>
...
<div class="my-orders">
   ...
   <section>
      ...
      <div class="box">
         ...
         <p> recipte Code : <span><?= $fetch_orders['address']; ?></span> </p>
         <p> payment method : <span><?= $fetch_orders['method']; ?></span> </p>
         <p> total_orders : <span><?= $fetch_orders['total_products']; ?></span> </p>
         <p> total price : <span>TND : <?= $fetch_orders['total_price']; ?></span> </p>
         <p> payment status : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else if($fetch_orders['payment_status'] == 'Accepted'){ echo 'orange'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
      </div>
      <?php
         }
      }else{
...
<div class="shopping-cart">
   ...
   <section>
      ...
      <div class="cart-total"> grand total : <span>TND : <?= $grand_total; ?></span></div>
...
<div class="home-bg">
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide">
            <div class="image">
               <img src="images/1525170730more.jpg" alt="">
            </div>
            <div class="content">
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/default_localized_bg_max_1199.webp" alt="">
         <h3>Buy & Sell in Tunisia</h3>
         <p>the leading people-powered echange marketplace today, is now in Tunisia.<BR> Take part in the emerging echange community in the country by converting your TND to USD ... in a trusted<BR> platform</p>
         <a href="#menu" class="btn">Echange</a>
      </div>

      <div class="box">
         <img src="images/about-2.svg" alt="">
         <h3>FAST</h3>
         <p>FAST SERVICE to simplify and speed up the work of the people who manage the service</p>
         <a href="#menu" class="btn">Echange</a>
      </div>

      <div class="box">
         <img src="images/money-dollar-exchange_318-60482.jpg" alt="">
         <h3>SAFE !</h3>
         <p>Our platform has an ultra-secure system that works round the clock to keep you and your money safe. On top of that,</p>
         <a href="#menu" class="btn">Echange</a>
      </div>
...
<section id="menu" class="menu">
   ...
   <h1 class="heading">our echange</h1>
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <div class="price">TND : <?= $fetch_products1['price'] ?></div>
         <img src="uploaded_img/<?= $fetch_products1['image'] ?>" alt="">
         <div class="name"><?= $fetch_products1['name'] ?></div>
         <form action="" method="post">
            <input type="hidden" name="pid" value="<?= $fetch_products1['id'] ?>">
            <input type="hidden" name="name" value="<?= $fetch_products1['name'] ?>">
            <input type="hidden" name="price" value="<?= $fetch_products1['price'] ?>">
            <input type="hidden" name="image" value="<?= $fetch_products1['image'] ?>">
...
<section class="order" id="order">
   ...
   <h1 class="heading">Echange now</h1>
   ...
   <?php
         ...
         if($select_cart->rowCount() > 0){
            while($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)){
              ...
              $total_products1 = implode($cart_item);
              echo '<p>'.$fetch_cart['name'].' <span>('.$fetch_cart['price'].' x '.$fetch_cart['quantity'].')</span></p>';
            }
         }else{
            echo '<p class="empty"><span>your cart is empty!</span></p>';
      ...
      <div class="grand-total"> grand total : <span>TND : <?= $grand_total; ?></span></div>

      <input type="hidden" name="total_products1" value="<?= $total_products1; ?>">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box">
               <option value="d17">D17     /(20390597)</option>
               <option value="POSTE">PAR POSTE    /(rafed taieb) Gafsa</option>
               <option value="BANK">RIP BANK           /(123456789123)</option>
         ...
         <div class="inputBox">
            <span>RECIPET(D17,poste...) * :</span>
            <input type="text" name="street" class="box" required placeholder="RECIPET" maxlength="50">
         </div>
         <div class="inputBox">
            <span>pin code :</span>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            echange is your ideal way to charge all your global electronic accounts quickly and safely. Hurry up to request your service now.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>rafedtaieb44@gmail.com</p>
         <p>rafedtaieb44@gmail</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>mr. Rafed Taieb</span> | all rights reserved! @layth essid
   </div>
